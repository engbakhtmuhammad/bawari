...
class CashFlowInfoScreen extends StatefulWidget {
  const CashFlowInfoScreen({super.key});

  @override
  State<CashFlowInfoScreen> createState() => _CashFlowInfoScreenState();
}

class _CashFlowInfoScreenState extends State<CashFlowInfoScreen> {
